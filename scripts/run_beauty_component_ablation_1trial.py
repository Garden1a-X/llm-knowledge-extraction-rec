#!/usr/bin/env python3
"""
Run 1-trial component ablation experiments on Amazon Beauty dataset.
...
Usage:
    ...
    python scripts/run_beauty_component_ablation_1trial.py --method all

    # Run specific ablation
    python scripts/run_beauty_component_ablation_1trial.py --method wo_contrast

    # Create configs only (don't run experiments)
    python scripts/run_beauty_component_ablation_1trial.py --create-configs-only
"""
...
# Base config for Beauty (same as ours_full_beauty.yaml)
BASE_CONFIG = {
    'name': 'ours_beauty_component_ablation',
    'description': 'Component ablation experiment on Amazon Beauty dataset',
...
def create_ablation_configs():
    """Create all component ablation config files for Beauty dataset."""
    ...
    for method, overrides in ABLATION_CONFIGS.items():
        ...
        config_path = config_dir / f"ours_beauty_component_{method}.yaml"
...
def main():
    parser = argparse.ArgumentParser(description='Run Beauty component ablation experiments (1 trial)')
    ...
    parser.add_argument('--output', type=str, default='results/beauty/component_ablation_results_1trial.json',
    ...
    print("\n" + "=" * 70)
    print("Beauty Component Ablation Experiments (1 Trial)")
    print("=" * 70)
