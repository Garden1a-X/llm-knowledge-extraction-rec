#!/bin/bash
# Run LightGCN baseline on Beauty dataset with 5 different seeds
# Usage: ./run_beauty_lightgcn_5trials.sh

CONFIG_FILE="configs/recbole_beauty_lightgcn.yaml"
MODEL="LightGCN"
...
echo "=========================================="
echo "Running LightGCN Baseline on Amazon Beauty"
echo "=========================================="
echo "Model: ${MODEL}"
...
OUTPUT_DIR="outputs/beauty_baselines/lightgcn_${TIMESTAMP}"
mkdir -p "${OUTPUT_DIR}"
...
echo "  python scripts/summarize_beauty_lightgcn_trials.py ${OUTPUT_DIR}"
echo ""
