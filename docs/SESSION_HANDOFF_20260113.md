...
### 1. 评估协议（重要！）
**已切换至uni100评估模式**（2026-01-17更新）
- 评估模式：uni100 (1 positive + 99 random negatives)
- 数据分割：70/10/20, Time-based ordering, per-user split
- 指标：NDCG@10（主）, Recall@10, Precision@10, Hit@10
- ⚠️ 注意：已从full ranking切换到uni100，以支持LLM baseline评估
...
**评估模式**: uni100 (2026-01-17更新)

| 类别 | 方法 | NDCG@10 | 状态 |
|------|------|---------|------|
| **传统CF** | BPR | 0.2196 ± 0.0018 | ✅ 完成 |
| **图谱** | LightGCN | 0.2255 ± 0.0012 | ✅ 完成 |
| **图谱** | KGAT | 0.2222 ± 0.0019 | ✅ 完成 |
| **多模态KG** | MKGAT | ? | ⏸️ 待运行 |
| **多模态图谱** | MMGCN | ? | ⏸️ 待运行 |
| **多模态图谱** | MGAT | ? | ⏸️ 待运行 |
...
| **Ours** | **Ours-Full** | **待更新** | ⚠️ 需重跑 |
| **消融** | w/o Contrast | 待更新 | ⚠️ 需重跑 |
| **消融** | w/o Mask | 待更新 | ⚠️ 需重跑 |
| **消融** | KG-only | 待更新 | ⚠️ 需重跑 |
| **消融** | CF-only | 待更新 | ⚠️ 需重跑 |

**⚠️ 重要更新（2026-01-18）**: 发现并修复数据泄露bug，所有Ours方法需重跑。详见 docs/WORK_LOG_20260118.md
