...
## 📈 实验结果（MovieLens-1M，5 trials）

**评估模式**: uni100 (1 positive + 99 random negatives)
**数据集**: MovieLens-1M (5-core filtered, 70/10/20 split)

### **Baseline对比结果**

| 方法 | NDCG@10 | Recall@10 | 提升 vs BPR | 提升 vs MKGAT |
|------|---------|-----------|-------------|---------------|
| **传统方法** |
| BPR | 0.2196 ± 0.0018 | 0.1518 ± 0.0013 | - | - |
| **图谱方法** |
| LightGCN | 0.2255 ± 0.0012 | 0.1536 ± 0.0020 | +2.7% | -1.7% |
| KGAT | 0.2222 ± 0.0019 | 0.1518 ± 0.0014 | +1.2% | -3.2% |
| **多模态图谱** ⭐ |
| **MKGAT** | **0.2295 ± 0.0061** | **0.4347 ± 0.0109** | **+4.5%** | - |
| **Ours方法** 💡🏆 |
| **Ours-Full** | **0.2707 ± 0.0026** 🚀 | **0.5006 ± 0.0041** 🚀 | **+23.3%** | **+18.0%** |

### **消融实验结果**

| 实验 | NDCG@10 | Recall@10 | vs Ours-Full |
|------|---------|-----------|--------------|
| Ours-Full | **0.2707 ± 0.0026** | **0.5006 ± 0.0041** | - |
| Ours w/o Contrast | 0.2639 ± 0.0017 | 0.4894 ± 0.0027 | -2.5% |
| Ours w/o Mask | 0.2690 ± 0.0046 | 0.4973 ± 0.0088 | -0.6% |
| Ours KG-only | 0.2410 ± 0.0097 | 0.4502 ± 0.0132 | -11.0% |
| Ours CF-only | 0.2652 ± 0.0006 | 0.4931 ± 0.0020 | -2.0% |

**关键发现**（数据泄漏bug修复后，2026-01-19）：
- ✅ **MKGAT是最强baseline**：多模态+KG融合（NDCG@10: 0.2295）
- ✅ **Ours-Full显著超越所有baseline**：+18.0% vs MKGAT（+23.3% vs BPR）
- ✅ **CF视图最关键**：去掉CF后性能下降11%
- ✅ **对比学习重要**：提升2.5%性能
- ✅ **KG视图有效**：CF+KG融合比纯CF提升2%
